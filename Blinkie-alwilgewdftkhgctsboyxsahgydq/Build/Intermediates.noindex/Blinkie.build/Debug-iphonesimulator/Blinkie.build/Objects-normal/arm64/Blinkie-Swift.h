...
#ifndef BLINKIE_SWIFT_H
#define BLINKIE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Blinkie",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Blinkie11AppDelegate")
...
SWIFT_CLASS("_TtC7Blinkie13SceneDelegate")
...
SWIFT_CLASS("_TtC7Blinkie14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified loginField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified passwordField;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified backgroundPhoto;
- (IBAction)loginButton:(id _Nonnull)sender;
- (IBAction)registerButton:(id _Nonnull)sender;
- (IBAction)signInGoogle:(id _Nonnull)sender;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7Blinkie23firstPageViewController")
...
@interface firstPageViewController (SWIFT_EXTENSION(Blinkie)) <UICollectionViewDelegateFlowLayout>
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface firstPageViewController (SWIFT_EXTENSION(Blinkie)) <UICollectionViewDelegate>
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UICollectionViewCell;

@interface firstPageViewController (SWIFT_EXTENSION(Blinkie)) <UICollectionViewDataSource>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC7Blinkie22infoCollectionViewCell")
...
SWIFT_CLASS("_TtC7Blinkie22registerViewController")
@interface registerViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified backgroundPhoto;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified topPhoto;
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified repeatPasswordField;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
